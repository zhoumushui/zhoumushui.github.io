...
(function () {
    ...
    x.w = {}, $.each(S, function (e, t) {
        ...
        var e = this.oDate.getFullYear(), t = this.oDate.getMonth() + 1, n = this.oDate.getDate(), r = T(t) + T(n),
            i = this.oDate.getDay(), s = Math.ceil(n / 7), o = T(t) + s + i, u = this.lMonth, a = this.lDate,
            f = u + "\u6708" + a, l = [];
...
(function () {
    var e = window.OB.RiLi, t = e.useLunarTicketDay, n = e.lunar, r = e.dateHuochepiao, i = [], s = {},
        ...
        f = "<em class='mh-lunar-ticket'>\u519c\u5386{l}</em>", l = function (e, t) {
    ...
    e.Huochepiao = {
        getHuochepiaoDay: function (e, t, n) {
            ...
            var s = this.getHuochepiaoDay(n, r, i), a = s["color"] == "red" ? "mh-hotticket" : "",
                f = o(s.piaodate.getMonth() + 1), l = o(s.piaodate.getDate()), c = [n, o(r), o(i)].join("/"),
            ...
            var i = this.getHuochepiaoDay(e, t, r), s = n(i.piaodate),
                o = s.lMonth.replace("\u5341\u4e8c", "\u814a") + "\u6708" + s.lDate;
            return $.format(f, {l: o})
        }, getHuochepiaoDayNongliProxy: function (e, t, r) {
            var i = this.getHuochepiaoDay(e, t, r), s = new Date(i.piaodate - 1728e5), o = n(s),
...
(function () {
    var e = window.OB.RiLi, t = e.msg_config, n = e.Huochepiao, r = e.mediator, i = e.lunar, s = e.Lunar,
        o = e.rootSelector || "", u = $.trim($(o + "#mh-date-y").html()), a = e.dateFestival, f = [], l, c, l, c;
    $.route = function (e, t) {
        e = e || {};
        var n;
    ...
    $.padWithZero = function (e) {
        ...
        options: {onselect: $.noop}, _create: function () {
            ...
            $(n.panel).delegate("li", "click", function () {
                ...
                var s = $(this).addClass("mh-on"), u = s.attr("date"), a = new Date(u), f = a.getFullYear(),
                    l = a.getMonth() + 1, c = null;
            ...
            var n = this, i = $(this.element), s = this.options, o = function (e) {
                ...
                var f = a, l = [], c = s < 10 ? "0" + s + "" : s + "", h = o < 10 ? "0" + o + "" : o + "",
                    p = u < 10 ? "0" + u + "" : u + "", d = "";
...
(function () {
    ...
    $.widget("rili.dayDetail", {
        options: {}, _create: function () {
            ...
            var i = this, s = $(this.element), o = this.options, u = n.getFullYear(), a = n.getMonth() + 1,
                f = n.getDate(), l = new Date, c = r.festival();
            ...
            var r = this, i = $(this.element), s = this.options, o = "d" + ("0" + t).slice(-2) + ("0" + n).slice(-2),
