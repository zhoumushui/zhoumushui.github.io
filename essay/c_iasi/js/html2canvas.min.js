...
!function (A, e) {
    ...
    for (var T = function (A) {
            ...
            return n
             ...
             t = 0; t < e.length; t++)Q[e.charCodeAt(t)] = t;
    function s(A, e, t) {
    ...
    function w(A, e, t, r, B) {
        ...
        if (-1 !== [D, y, v, p, N].indexOf(c))for (var Q = n; 0 <= Q;) {
            if ((w = e[Q]) === D)return Y;
            if (-1 === [y, v].indexOf(w))break;
            Q--
        }
        if (-1 !== [M, S].indexOf(c))for (Q = -1 !== [p, N].indexOf(i) ? s : n; 0 <= Q;) {
            var w;
            if ((w = e[Q]) === D)return Y;
            if (-1 === [y, v].indexOf(w))break;
            Q--
    ...
    var a, U, E, F, h, H = 10, d = 13, f = 15, p = 17, N = 18, m = 19, R = 20, L = 21, O = 22, v = 24, D = 25, S = 26,
        ...
        }(U, Math.ceil((24 + U[4]) / 4)), new o(U[0], U[1], U[2], U[3], F, h)), Z = [_, 36], j = [1, 2, 3, 5],
        $ = [H, 8], AA = [M, S], eA = j.concat($), tA = [J, G, k, V, z], rA = [f, d],
    ...
    var CA = {type: sA.LEFT_PARENTHESIS_TOKEN}, gA = {type: sA.RIGHT_PARENTHESIS_TOKEN}, EA = {type: sA.COMMA_TOKEN},
        ...
        DA = {type: sA.RIGHT_SQUARE_BRACKET_TOKEN}, SA = {type: sA.WHITESPACE_TOKEN}, bA = {type: sA.EOF_TOKEN},
        MA = (yA.prototype.write = function (A) {
            ...
            if (t) {
                var r = parseInt(l.apply(void 0, A.map(function (A) {
                    return 63 === A ? 48 : A
                })), 16), B = parseInt(l.apply(void 0, A.map(function (A) {
                    return 63 === A ? 70 : A
                })), 16);
            ...
            if ((69 === t || 101 === t) && ((43 === r || 45 === r) && iA(B) || iA(r)))for (A.push(this.consumeCodePoint(), this.consumeCodePoint()), e = 8; iA(this.peekCodePoint(0));)A.push(this.consumeCodePoint());
            return [function (A) {
                var e = 0, t = 1;
    ...
    function te(A) {
        var e = 255 & A, t = 255 & A >> 8, r = 255 & A >> 16, B = 255 & A >> 24;
    ...
    function le(A) {
        var e = A.filter(kA), t = e[0], r = e[1], B = e[2], n = e[3],
            s = (t.type === sA.NUMBER_TOKEN ? Qe(t.number) : ce(t)) / (2 * Math.PI), o = qA(r) ? r.number / 100 : 0,
            i = qA(B) ? B.number / 100 : 0, a = void 0 !== n && qA(n) ? ae(n, 1) : 1;
    ...
    var Ce, ge, Ee, Fe, he = {hsl: le, hsla: le, rgb: Be, rgba: Be}, He = {
    ...
    function pe(A, e, t) {
        var r = "number" == typeof A ? A : function (A, e, t) {
                var r = e / 2, B = t / 2, n = ae(A[0], e) - r, s = B - ae(A[1], t);
                return (Math.atan2(s, n) + 2 * Math.PI) % (2 * Math.PI)
            }(A, e, t), B = Math.abs(e * Math.sin(r)) + Math.abs(t * Math.cos(r)), n = e / 2, s = t / 2, o = B / 2,
    ...
    var ye = (_e.prototype.addImage = function (A) {
        ...
        return new Promise(function (e, t) {
            ...
            if (B.onload = function () {
                    if (200 === B.status)if ("text" == r) e(B.response); else {
            ...
            return WA(A).forEach(function (A, e) {
                ...
                if (t.type === sA.FUNCTION)if ("from" === t.name) {
                    ...
                    if (2 === B.length) {
                        ...
                        var n = B[0];
                        VA(n) && s.push({
                            stop: {type: sA.PERCENTAGE_TOKEN, number: 100 * n.number, flags: n.flags},
                            color: r
                        })
                    }
                }
    ...
    var Dt, St, bt = Ot("top"), Mt = Ot("right"), yt = Ot("bottom"), _t = Ot("left"), Pt = vt("top"), xt = vt("right"),
    ...
    var Ir, Tr, mr = {
        ...
        name: "text-shadow", initialValue: "none", type: Ce.LIST, prefix: !1, parse: function (A) {
            return 1 === A.length && JA(A[0], "none") ? [] : WA(A).map(function (A) {
                for (var e = {color: He.TRANSPARENT, offsetX: se, offsetY: se, blur: se}, t = 0,
                         r = 0; r < A.length; r++) {
                    var B = A[r];
    ...
    var Lr, Or, vr = {
        ...
        matrix: function (A) {
            ...
            var e = A.filter(function (A) {
                    ...
                    return A.number
                }), t = e[0], r = e[1], B = (e[2], e[3], e[4]), n = e[5], s = (e[6], e[7], e[8], e[9], e[10], e[11], e[12]),
                o = e[13];
            e[14], e[15];
            return 16 === e.length ? [t, r, B, n, s, o] : null
        }
    }, br = {type: sA.PERCENTAGE_TOKEN, number: 50, flags: 4}, Mr = [br, br], yr = {
    ...
    var tB = {
        ...
        name: "box-shadow", initialValue: "none", type: Ce.LIST, prefix: !1, parse: function (A) {
            return 1 === A.length && JA(A[0], "none") ? [] : WA(A).map(function (A) {
                for (var e = {color: 255, offsetX: se, offsetY: se, blur: se, spread: se, inset: !1}, t = 0,
                         r = 0; r < A.length; r++) {
                    var B = A[r];
    ...
    var cB, QB = function (A) {
        ...
        this.text = HB(A.data, e.textTransform), this.textBounds = function (A, t, r) {
            ...
            return e.forEach(function (A) {
                if (t.textDecorationLine.length || 0 < A.trim().length)if (ve.SUPPORT_RANGE_BOUNDS) B.push(new lB(A, gB(r, n, A.length))); else {
    ...
    function LB(A) {
        var e = mB.call(this, A) || this, t = new XMLSerializer;
    ...
    var yB, _B = [{type: sA.DIMENSION_TOKEN, flags: 0, unit: "px", number: 3}],
        PB = [{type: sA.PERCENTAGE_TOKEN, flags: 0, number: 50}], xB = "checkbox", VB = "radio", zB = "password",
        XB = 707406591, JB = (A(GB, yB = UB), GB);
    ...
    function YB(A) {
        var e = kB.call(this, A) || this, t = A.options[A.selectedIndex || 0];
    ...
    var Bn = ["OL", "UL", "MENU"], nn = function (A, e, t) {
        for (var r = A.firstChild,
                 B = void 0; r; r = B)if (B = r.nextSibling, Qn(r) && 0 < r.data.trim().length) e.textNodes.push(new hB(r, e.styles)); else if (wn(r)) {
            var n = sn(r);
    ...
    var Ln, On, vn = {
        ...
        var B = A.defaultView.pageXOffset, n = A.defaultView.pageYOffset, s = r.contentWindow, o = s.document,
        ...
        if (un(A) && e) {
            var t = this.createElementClone(A), r = e.getComputedStyle(A), B = e.getComputedStyle(A, ":before"),
                n = e.getComputedStyle(A, ":after");
            this.referenceElement === A && (this.clonedReferenceElement = t), En(t) && $n(t);
            for (var s = this.counters.parse(new wB(r)), o = this.resolvePseudoContent(A, t, B, Ln.BEFORE),
                     i = A.firstChild; i; i = i.nextSibling)wn(i) && ("SCRIPT" === i.tagName || i.hasAttribute(_n) || "function" == typeof this.options.ignoreElements && this.options.ignoreElements(i)) || this.options.copyStyles && wn(i) && rn(i) || t.appendChild(this.cloneNode(i));
    ...
    var Vn, zn, Xn = function (A, e) {
        ...
        }, qn = "___html2canvas___pseudoelement_before", Zn = "___html2canvas___pseudoelement_after",
    ...
    var ns = (ss.prototype.subdivide = function (A, e) {
        var t = Bs(this.start, this.startControl, A), r = Bs(this.startControl, this.endControl, A),
            B = Bs(this.endControl, this.end, A), n = Bs(t, r, A), s = Bs(r, B, A), o = Bs(n, s, A);
    ...
    var is, as, cs = function (A) {
        var e = A.styles, t = A.bounds, r = jA(e.borderTopLeftRadius, t.width, t.height), B = r[0], n = r[1],
    ...
    function Es(A, e) {
        if (this.container = A, this.effects = e.slice(0), this.curves = new cs(A), null !== A.styles.transform) {
            var t = A.bounds.left + A.styles.transformOrigin[0].number,
                r = A.bounds.top + A.styles.transformOrigin[1].number, B = A.styles.transform;
    ...
    function hs(A) {
        var e = A.styles, t = A.bounds, r = ae(e.paddingLeft, t.width), B = ae(e.paddingRight, t.width),
            n = ae(e.paddingTop, t.width), s = ae(e.paddingBottom, t.width);
    ...
    function Hs(A, e, t) {
        var r = function (A, e) {
            ...
            }(Ts(A.styles.backgroundOrigin, e), A), B = function (A, e) {
                return A === Ee.BORDER_BOX ? e.bounds : A === Ee.CONTENT_BOX ? hs(e) : Fs(e)
            }(Ts(A.styles.backgroundClip, e), A), n = Is(Ts(A.styles.backgroundSize, e), t, r), s = n[0], o = n[1],
    ...
    }, Rs = "Hidden Text", Ls = (Os.prototype.parseMetrics = function (A, e) {
                ...
                switch (A.label) {
                    case 0:
                        v = S.styles.backgroundImage.length - 1, e = function (e) {
                            var t, r, B, n, s, o, i, a, c, Q, w, u, U, l, C, g, E, F, h, H, d, f, p, N, K, I, T, m, R,
                                L, O;
                            return b(this, function (A) {
                                switch (A.label) {
                                    case 0:
                                            ...
                                            return A.type === xe.LINEAR_GRADIENT
                                                ...
                                                switch (A.size) {
                                                    ...
                                                    case nt.CLOSEST_CORNER:
                                                        if (A.shape === rt.CIRCLE) n = s = Math.min(Ne(e, t), Ne(e, t - B), Ne(e - r, t), Ne(e - r, t - B)); else if (A.shape === rt.ELLIPSE) {
                                                            var o = Math.min(Math.abs(t), Math.abs(t - B)) / Math.min(Math.abs(e), Math.abs(e - r)),
                                                                i = Ke(r, B, e, t, !0), a = i[0], c = i[1];
                                                            s = o * (n = Ne(a - e, (c - t) / o))
                                                        }
                                                        break;
                                                    ...
                                                    case nt.FARTHEST_CORNER:
                                                        if (A.shape === rt.CIRCLE) n = s = Math.max(Ne(e, t), Ne(e, t - B), Ne(e - r, t), Ne(e - r, t - B)); else if (A.shape === rt.ELLIPSE) {
