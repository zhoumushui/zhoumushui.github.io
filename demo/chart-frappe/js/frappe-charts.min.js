var Chart = function () {
    ...
    function b(t, e, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1, s = i.x + t.x, r = i.y + t.y,
            o = i.x + e.x, l = i.y + e.y;
        return "M" + i.x + " " + i.y + "\n\t\tL" + s + " " + r + "\n\t\tA " + n + " " + n + " 0 0 " + (a ? 1 : 0) + "\n\t\t" + o + " " + l + " z"
    }
    ...
    function x(t, e) {
        var i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
            n = "path-fill-gradient-" + e + "-" + (i ? "lighter" : "default"), a = d(t, n), s = [1, .6, .2];
    ...
    function M(t, e, i) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {}, a = p("text", {
            ...
            "text-anchor": "start",
            innerHTML: e + ""
        }), s = T(t, "", 0, i, {stroke: n.stroke || Dt, className: n.className || "", lineType: n.lineType});
    ...
    function O(t, e, i, n) {
        var a = t - e, s = p("rect", {
            className: "bar mini",
            styles: {fill: "rgba(228, 234, 239, 0.49)", stroke: Dt, "stroke-dasharray": i + ", " + a},
            x: 0,
            y: 0,
            width: i,
            height: a
    ...
    function C(t, e, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : "",
            ...
            o = arguments.length > 7 && void 0 !== arguments[7] ? arguments[7] : {}, l = h(e, o.zeroLine), c = xt(l, 2),
            u = c[0], d = c[1], f = p("rect", {
                className: "bar mini",
                style: "fill: " + n,
                "data-point-index": s,
                x: t,
    ...
    function D(t, e, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : "",
            s = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 0,
            r = p("circle", {style: "fill: " + n, "data-point-index": s, cx: t, cy: e, r: i});
        if ((a += "") || a.length) {
    ...
    function S(t, e) {
        var i = Et(t), n = !1;
        "#" == i[0] && (i = i.slice(1), n = !0);
        var a = parseInt(i, 16), s = N((a >> 16) + e), r = N((a >> 8 & 255) + e), o = N((255 & a) + e);
    ...
    function R(t, e, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0,
            s = h(i, (arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : {}).zeroLine), r = xt(s, 2),
            o = r[0], l = r[1];
    ...
    function I(t, e, i, n) {
        ...
        if (a.push(r), t.region) {
            var o = e[0] + "," + n + "L", l = "L" + e.slice(-1)[0] + ", " + n,
                h = [t.region, {d: "M" + o + s + l}, Rt, Gt];
            a.push(h)
        }
        return a
    }
    ...
    function it(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, i = tt(t), n = xt(i, 2), a = n[0],
            s = n[1], r = e ? e / Math.pow(10, s) : 0, o = et(a = a.toFixed(6), r);
    ...
    function nt(t) {
        ...
        var i = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = Math.max.apply(Math, kt(t)),
            a = Math.min.apply(Math, kt(t)), s = [];
    ...
    function pt(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [],
            i = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2], n = t / e.length / Pt;
    ...
    var wt = function () {
        ...
        }(), At = 700, Tt = ["line", "bar"], Pt = 7, Lt = Math.PI / 180, Mt = 6, Ot = 4, Ct = 10, Dt = "#dadada", _t = {
            bar: function (t) {
                var e = void 0;
        ...
        Et = function (t) {
                ...
                key: "bindTooltip", value: function () {
                    ...
                    this.chartWrapper.addEventListener("mousemove", function (n) {
                        ...
                        if (a.classList.contains("progress-bar")) {
                            var s = a.getAttribute("data-index"), r = e(t.chartWrapper), o = e(a),
                                l = o.left - r.left + a.offsetWidth / 2, h = o.top - r.top - 6,
            ...
            function t(e) {
                var i = e.layerClass, n = void 0 === i ? "" : i, a = e.layerTransform, s = void 0 === a ? "" : a,
                    r = e.constants, o = e.getData, l = e.makeElements, h = e.animateElements;
            ...
            pieSlices: {
                ...
                layerClass: "y axis", makeElements: function (t) {
                    ...
                    var e = t.positions, i = t.labels, n = this.oldData.positions, a = this.oldData.labels, s = c(n, e),
                        r = xt(s, 2);
                    n = r[0], e = r[1];
                ...
                layerClass: function () {
                    ...
                    var e = t.xPositions, i = t.yPositions, n = t.offsets, a = t.labels, s = this.oldData.xPositions,
                        r = this.oldData.yPositions, o = this.oldData.offsets, l = this.oldData.labels, h = c(s, e),
                        u = xt(h, 2);
                    s = u[0], e = u[1];
                ...
                layerClass: function () {
                    ...
                    var e = t.xPositions, i = t.yPositions, n = t.values, a = this.oldData.xPositions,
                        s = this.oldData.yPositions, r = this.oldData.values, o = c(a, e), l = xt(o, 2);
                    a = l[0], e = l[1];
            ...
            return mt(i, t), gt(i, [{
                ...
                key: "calcSlices", value: function () {
                    ...
                    e.sliceTotals.map(function (r, o) {
                        var h = s, c = r / e.grandTotal * 360, u = n ? -c : c, p = s += u, d = l(h, i), f = l(p, i),
                            v = t.init && a[o], g = void 0, y = void 0;
            ...
            return mt(e, t), gt(e, [{
                ...
                key: "renderAllWeeksAndStoreXValues", value: function (t) {
                    ...
                    for (var i = 0; i < t; i++) {
                        var n = void 0, a = 0, s = new Date(e), r = this.get_week_squares_group(s, this.weekCol),
                            o = xt(r, 2);
                ...
                key: "get_week_squares_group", value: function (t, e) {
                    for (var i = this.today.getTime(), n = 0, a = 0, s = y(this.dataGroups, "data-group"), r = 0, o = 0; o < 7; o += 1, r += 12) {
                        ...
                        var p = 13 + 12 * (e + a), d = {"data-date": K(t), "data-value": l, "data-day": t.getDay()},
                ...
                key: "bindTooltip", value: function () {
                    ...
                    Array.prototype.slice.call(document.querySelectorAll(".data-group .day")).map(function (e) {
                        e.addEventListener("mouseenter", function (e) {
                            var i = e.target.getAttribute("data-value"), n = e.target.getAttribute("data-date").split("-"),
                                a = t.monthNames[parseInt(n[1]) - 1].substring(0, 3),
                                s = t.chartWrapper.getBoundingClientRect(), r = e.target.getBoundingClientRect(),
                                o = parseInt(e.target.getAttribute("width")), l = r.left - s.left + (o + 2) / 2,
                                h = r.top - s.top - (o + 2) / 2, c = i + " " + t.countLabel,
                                u = " on " + a + " " + n[0] + ", " + n[2];
            ...
            return mt(n, i), gt(n, [{
                ...
                key: "calcYAxisParameters", value: function (t) {
                    var e = nt(t, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "false"),
                        i = this.height / rt(e), n = st(e) * i, a = this.height - at(e) * n;
                    this.state.yAxis = {
                    ...
                    if (i.yExtremes) {
                        ...
                        for (var r = i.datasetLength - 1; r >= 0; r--) {
                            ...
                            if (t > o - i.unitWidth / 2) {
                                var l = o + this.leftMargin, h = i.yExtremes[r] + this.translateY,
