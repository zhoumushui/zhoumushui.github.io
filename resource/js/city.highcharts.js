...
(function () {
    ...
    L = {
        ...
        colors: "#2196F3,#607D8B,#009688,#f7a35c,#673AB7,#E91E63,#FFC107,#3F51B5,#795548,#91e8e1".split(","),
    ...
    ta.prototype = {
        Element: G, init: function (a, b, c, d, e) {
            ...
            for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString(),
                     f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = F(b, "x"), k = a.styles, l = a.textWidth,
                     m = k && k.lineHeight, n = k && k.HcTextStroke, o = g.length, Y = function (a) {
                    ...
                    if (e !==
                        ...
                        if (e !== " ") {
                            ...
                            if (l)for (var e = e.replace(/([^\^])-/g,
                                "$1- ").split(" "), n = g.length > 1 || e.length > 1 && k.whiteSpace !== "nowrap", q, E,
                                           s = k.HcHeight, u = [], t = Y(o),
                                           Kb = 1; n && (e.length || u.length);)delete a.bBox, q = a.getBBox(), E = q.width, !ba && c.forExport && (E = c.measureSpanWidth(o.firstChild.data, a.styles)), q = E > l, !q || e.length === 1 ? (e = u, u = [], e.length && (Kb++, s && Kb * t > s ? (e = ["..."], a.attr("title", a.textStr)) : (o = x.createElementNS(xa, "tspan"), F(o, {
                                dy: t,
                                x: j
    ...
    if (!ba && !ga) {
        Z = {
            init: function (a,
                ...
                for (var b = a.length,
                         c = []; b--;)if (ia(a[b])) c[b] = v(a[b] * 10) - 5; else if (a[b] === "Z") c[b] = "x"; else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at")) c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1), c[b + 6] === c[b + 8] && (c[b + 8] += a[b + 8] > a[b + 6] ? 1 : -1);
                return c.join(" ") || "x"
            }, clip: function (a) {
                var b = this, c;
    ...
    ma.prototype = {
        ...
        defaultYAxisOptions: {
            ...
            startOnTick: !0,
            tickWidth: 0,
            title: {rotation: 270, text: ""}, // AZ:Y轴单位
            stackLabels: {
    ...
    r(ma.prototype, {
        getPlotBandPath: function (a, b) {
            ...
            for (var b =
                    this.plotLinesAndBands, c = this.options, d = this.userOptions,
    ...
    ma.prototype.getTimeTicks = function (a, b, c, d) {
        ...
        if (s(b)) {
            ...
            h = i[fb]();
            for (var d = i.getTime(), l = i[eb](), m = i[Wa](),
                     n = g ? Ra : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;)e.push(d), j === B.year ? d = db(h + b * k, 0) : j === B.month ? d = db(h, l + b * k) : !g && (j === B.day || j === B.week) ? d = db(h, l, m + b * k * (j === B.day ? 1 : 7)) : d += j * k, b++;
            e.push(d);
            q(vb(e, function (a) {
                return j <=
                    B.hour && a % B.day === n
    ...
    ma.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5) a = v(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = U(b), h, i, j,
                                                                                                      k, l,
    ...
    O.prototype = {
        ...
        init: function (a, b) {
            ...
            q(f, function (a, b) {
                ...
                a.name = a.name || "" // AZ:Do not show spline title
            })
        },
        bindAxes: function () {
    ...
    O.prototype.setPercentStacks = function () {
        ...
        q([b, "-" + b], function (b) {
            ...
            for (var f = d.length, g,
                     h; f--;)if (g = d[f], e = (h = c[b] && c[b][g]) && h.points[a.index + "," + f], g = e) h = h.total ? 100 / h.total : 0, g[0] = ea(g[0] * h), g[1] = ea(g[1] * h), a.stackedYData[f] = g[1]
        })
    };
    r(Xa.prototype, {
